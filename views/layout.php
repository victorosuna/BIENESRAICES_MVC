...
<body>
        ...
        <div class="contenedor contenido-header">
            <div class="barra">
                ...
                <nav class="navegacion">
                    <a class="a1" href="/nosotros">Nosotros</a>
                    <a class="a2" href="/propiedades">Anuncios</a>
                    <a class="a3" href="/blog">Blog</a>
                    <a class="a4" href="/contacto">Contacto</a>
                    <?php if($auth): ?>
    ...
    <footer class="footer seccion">
        ...
        <p class="copyright">Todos los derechos reservados <?php echo date("Y"); ?>.  Copyright</p>
    </footer>
